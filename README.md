...
monitoring. Detects vibration anomalies, and temperature excursions, variations — uploading live data to the cloud via GPRS 
for remote predictive maintenance.

Live System Data
The system was deployed and tested with real sensor data streamed to ThingSpeak:
